                ...
                <div class="card-body">
                    <div class="list-group">
                        <?php foreach ($tables as $table): ?>
                            <a href="?id=<?php echo $websiteId; ?>&tab=database&action=table&table=<?php echo urlencode($table); ?>" 
                                            ...
                                            <ul class="pagination">
                                                ...
                                                ?>
                                                    <li class="page-item <?php echo $i == $page ? 'active' : ''; ?>">
                                                        <a class="page-link" href="?id=<?php echo $websiteId; ?>&tab=database&action=table&table=<?php echo urlencode($tableName); ?>&page=<?php echo $i; ?>">
                                                            <?php echo $i; ?>
                                                        </a>
                                                    </li>
                                                <?php endfor; ?>
